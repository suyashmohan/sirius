...
${OBJECTDIR}/Sirius/Entity.o: Sirius/Entity.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Entity.o Sirius/Entity.cpp

${OBJECTDIR}/Sirius/Game.o: Sirius/Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Game.o Sirius/Game.cpp

${OBJECTDIR}/Sirius/Graphic.o: Sirius/Graphic.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Graphic.o Sirius/Graphic.cpp

${OBJECTDIR}/Sirius/Image.o: Sirius/Image.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Image.o Sirius/Image.cpp

${OBJECTDIR}/Sirius/Input.o: Sirius/Input.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Input.o Sirius/Input.cpp

${OBJECTDIR}/Sirius/Renderer.o: Sirius/Renderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Renderer.o Sirius/Renderer.cpp

${OBJECTDIR}/Sirius/ResourceManager.o: Sirius/ResourceManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/ResourceManager.o Sirius/ResourceManager.cpp

${OBJECTDIR}/Sirius/Scene.o: Sirius/Scene.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Scene.o Sirius/Scene.cpp

${OBJECTDIR}/Sirius/Texture.o: Sirius/Texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Texture.o Sirius/Texture.cpp

${OBJECTDIR}/Sirius/Utility.o: Sirius/Utility.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Utility.o Sirius/Utility.cpp

${OBJECTDIR}/Sirius/Window.o: Sirius/Window.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sirius
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sirius/Window.o Sirius/Window.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilib/SDL2-2.0.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
